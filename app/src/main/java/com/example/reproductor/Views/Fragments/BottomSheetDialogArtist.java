...
import com.example.reproductor.Models.Adapters.SongsArtistBottomSheet;
...
public class BottomSheetDialogArtist extends BottomSheetDialogFragment implements OpenBottomSheetArtist {
    ...
    public BottomSheetDialogArtist(ArtistModel artist) {
        this.artist = artist;
    ...
    public void sendPositionArtist(int position) {
        sendData.getData(artist.getCanciones().get(position), null);
        dismiss();
    }
